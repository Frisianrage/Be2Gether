  ...
  const handleChange = (e) => {
    ...
    return ( 
        <div className="partnersearch">
            ...
            <input id="partnersearch" type="text" placeholder="Look for your partner" onChange={handleChange} name="partner" ></input><br /><button onClick={handleClick}>Search</button> 
        </div>
          )
}